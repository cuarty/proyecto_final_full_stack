            ...
            <table class="table">
                ...
                <tbody>
                    <%
                        ...
                        tipoLibro.setGenero((String) request.getAttribute("buscarGenero"));

//                        librito = "Ojos de Fuego";
                        // Obtener la lista de oradores desde la base de datos
                        List<Libros> listaLibros = librosDAO.obtenerPorGenero(tipoLibro.getGenero());
        ...
        <!--        <div style="margin-top: 50px">
                ...
                <div class="container mt-3">            
                    ...
                    <form action="OperacionServlet" method="post" class="mb-3">                
                        ...
                        <br> 
                        <input type="hidden" name="accion" value="borrarTituloPorGenero">
                        <button type="submit" class="btn btn-danger">Borrar</button>
                        <br>
                    </form>
                </div>-->
<!--        <footer class="bg-dark text-white text-center py-3" style="width: 100%; margin-top: 100px; margin-right: 0px; margin-left: 0px; margin-bottom: 0px">
