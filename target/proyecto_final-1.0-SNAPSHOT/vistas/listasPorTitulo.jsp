        ...
        <div class="container mt-5">
            ...
            <table class="table">
                ...
                <%
                    ...
                    tipoLibro.setTitulo((String) request.getAttribute("buscarTitulo"));
                    String librito = (String) request.getAttribute("buscarTitulo");

//                        librito = "Ojos de Fuego";
                    // Obtener la lista de oradores desde la base de datos
                    List<Libros> listaLibros = librosDAO.obtenerPorTitulo(tipoLibro.getTitulo());
        ...
        <!--        <div style="margin-top: 50px">
                ...
                <div class="container mt-3">            
                    ...
                    <form action="OperacionServlet" method="post" class="mb-3">                
                        ...
                        <br> 
                        <input type="hidden" name="accion" value="borrarTituloPorTitulo">
